[README.md](https://github.com/user-attachments/files/30484775/README.md)
...
```bash
python verify_book_numbers.py    # every number in the book, checked against a fresh run
```
...
Open an issue. Reports that a published number does not reproduce are especially welcome, and will be acknowledged in `docs/verification.md`.
